...
void main() {
  ...
  late NeoVideoPlayerController controller;
  tearDown(() async => controller.dispose());

  group('asset videos', () {
    setUp(() {
      controller = NeoVideoPlayerController.asset(_videoAssetKey);
    });
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final NeoVideoPlayerController networkController =
              ...
              builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
                if (snapshot.data ?? false) {
                  return AspectRatio(
                    ...
                    child: NeoVideoPlayer(controller),
                  );
                } else {
  ...
  group('file-based videos', () {
    setUp(() async {
      ...
      controller = NeoVideoPlayerController.file(file);
    });
  ...
  group('network videos', () {
    setUp(() {
      controller = NeoVideoPlayerController.network(
  ...
  group('asset audios', () {
    setUp(() {
      controller = NeoVideoPlayerController.asset('assets/Audio.mp3');
    });
