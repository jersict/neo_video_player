...
class _ButterFlyAssetVideoState extends State<_ButterFlyAssetVideo> {
  late NeoVideoPlayerController _controller;

  @override
  void initState() {
    super.initState();
    _controller = NeoVideoPlayerController.asset('assets/Butterfly-209.mp4');
...
class _BumbleBeeRemoteVideoState extends State<_BumbleBeeRemoteVideo> {
  ...
  void initState() {
    super.initState();
    _controller = NeoVideoPlayerController.network(
...
class _PlayerVideoAndPopPageState extends State<_PlayerVideoAndPopPage> {
  late NeoVideoPlayerController _videoPlayerController;
  ...
  void initState() {
    ...
    _videoPlayerController =
        NeoVideoPlayerController.asset('assets/Butterfly-209.mp4');
          ...
          builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
            if (snapshot.data ?? false) {
              return AspectRatio(
                ...
                child: NeoVideoPlayer(_videoPlayerController),
              );
            } else {
