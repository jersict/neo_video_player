...
export 'package:neo_video_player_platform_interface/neo_video_player_platform_interface.dart'
...
VideoPlayerPlatform get _videoPlayerPlatform {
  final currentInstance = VideoPlayerPlatform.instance;
...
/// of a [NeoVideoPlayerController].
class NeoVideoPlayerValue {
  ...
  NeoVideoPlayerValue.uninitialized()
      : this(duration: Duration.zero, isInitialized: false);

  /// Returns an instance with the given [errorDescription].
  NeoVideoPlayerValue.erroneous(String errorDescription)
      : this(
  ...
  /// This constant is just to indicate that parameter is not passed to
  /// [copyWith] workaround for this issue:
  ///  https://github.com/dart-lang/language/issues/2009
  ...
  /// The [Duration] that should be used to offset the current [position] to get
  /// the correct [Caption].
  ///
...
///
/// The video is displayed in a Flutter app by creating a [NeoVideoPlayer]
/// widget.
///
/// To reclaim the resources used by the player call [dispose].
///
/// After [dispose] all further calls are ignored.
class NeoVideoPlayerController extends ValueNotifier<NeoVideoPlayerValue> {
  /// Constructs a [NeoVideoPlayerController] playing a video from an asset.
  ///
  ...
  NeoVideoPlayerController.asset(
    this.dataSource, {
    this.package,
    ...
    this.videoPlayerOptions,
        ...
        super(NeoVideoPlayerValue(duration: Duration.zero));

  /// Constructs a [NeoVideoPlayerController] playing a video from obtained from
  /// the network.
  ///
  ...
  NeoVideoPlayerController.network(
    this.dataSource, {
    this.formatHint,
    Future<ClosedCaptionFile>? closedCaptionFile,
    this.videoPlayerOptions,
  ...
  /// Constructs a [NeoVideoPlayerController] playing a video from a file.
  ///
  ...
  /// Constructs a [NeoVideoPlayerController] playing a video from a contentUri.
  ///
  /// This will load the video from the input content-URI.
  /// This is supported on Android only.
  NeoVideoPlayerController.contentUri(
    Uri contentUri, {
    Future<ClosedCaptionFile>? closedCaptionFile,
    this.videoPlayerOptions,
  })  : assert(
  ...
  /// Only for [NeoVideoPlayerController.network].
  ...
  /// Describes the type of data source this [NeoVideoPlayerController]
  /// is constructed with.
  ...
  Future<void> initialize() async {
    ...
    void errorListener(Object obj) {
      ...
      value = NeoVideoPlayerValue.erroneous(e.message!);
      _timer?.cancel();
  ...
  Future<void> togglePip() async {
    await _applyTogglePip();
  }

  Future<void> _applyTogglePip() async {
    if (_isDisposedOrNotInitialized) {
      return;
    }
    await _videoPlayerPlatform.togglePip(textureId);
  }
  ...
  ///
  /// The [offset] will be used when getting the correct caption for a specific
  /// position.
  ...
  ///
  /// * \>0: The caption will have a negative offset. So you will get caption
  /// text from the past.
  ///
  /// * <0: The caption will have a positive offset. So you will get caption
  ...
  void removeListener(VoidCallback listener) {
    // Prevent VideoPlayer from causing an exception to be thrown when
    // attempting to
...
class _VideoAppLifeCycleObserver extends Object with WidgetsBindingObserver {
  ...
  final NeoVideoPlayerController _controller;
...
class NeoVideoPlayer extends StatefulWidget {
  /// Uses the given [controller] for all video rendered in this widget.
  const NeoVideoPlayer(this.controller, {super.key});

  /// The [NeoVideoPlayerController] responsible for the video being rendered in
  /// this widget.
  final NeoVideoPlayerController controller;

  @override
  State<NeoVideoPlayer> createState() => _NeoVideoPlayerState();
}

class _NeoVideoPlayerState extends State<NeoVideoPlayer> {
  _NeoVideoPlayerState() {
    _listener = () {
  ...
  @override
  void didUpdateWidget(NeoVideoPlayer oldWidget) {
  ...
  Widget build(BuildContext context) {
    return _textureId == NeoVideoPlayerController.kUninitializedTextureId
        ? Container()
...
/// A scrubber to control [NeoVideoPlayerController]s
class VideoScrubber extends StatefulWidget {
  /// Create a [VideoScrubber] handler with the given [child].
  ///
  /// [controller] is the [NeoVideoPlayerController] that will be controlled by
  /// this scrubber.
  const VideoScrubber({
    required this.child,
  ...
  /// The [NeoVideoPlayerController] that will be controlled by this scrubber.
  final NeoVideoPlayerController controller;
...
class _VideoScrubberState extends State<VideoScrubber> {
  ...
  NeoVideoPlayerController get controller => widget.controller;
...
class VideoProgressIndicator extends StatefulWidget {
  ...
  /// The [NeoVideoPlayerController] that actually associates a video with this
  /// widget.
  final NeoVideoPlayerController controller;
...
/// [NeoVideoPlayerController.closedCaptionFile].
///
/// Usage:
///
/// ```dart
