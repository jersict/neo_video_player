...
import 'package:neo_video_player/src/sub_rip.dart';
import 'package:neo_video_player/src/web_vtt.dart';
...
class Caption {
  ...
  /// A no caption object. This is a caption with [start] and [end] durations
  /// of zero, and an empty [text] string.
