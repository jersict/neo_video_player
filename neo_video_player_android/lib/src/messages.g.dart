...
class TogglePipMessage {
  ...
  static TogglePipMessage decode(Object message) {
    final Map<Object?, Object?> pigeonMap = message as Map<Object?, Object?>;
    return TogglePipMessage(
      textureId: pigeonMap['textureId']! as int,
    );
  }
}
...
class AndroidVideoPlayerApi {
  ...
  Future<void> togglePip(TogglePipMessage arg_msg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AndroidVideoPlayerApi.togglePip', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_msg]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
