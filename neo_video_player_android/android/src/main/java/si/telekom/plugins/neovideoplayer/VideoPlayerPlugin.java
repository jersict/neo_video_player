...
import si.telekom.plugins.neovideoplayer.Messages.AndroidVideoPlayerApi;
import si.telekom.plugins.neovideoplayer.Messages.CreateMessage;
import si.telekom.plugins.neovideoplayer.Messages.LoopingMessage;
import si.telekom.plugins.neovideoplayer.Messages.MixWithOthersMessage;
import si.telekom.plugins.neovideoplayer.Messages.PlaybackSpeedMessage;
import si.telekom.plugins.neovideoplayer.Messages.PositionMessage;
import si.telekom.plugins.neovideoplayer.Messages.TextureMessage;
import si.telekom.plugins.neovideoplayer.Messages.VolumeMessage;

/** Android platform implementation of the VideoPlayerPlugin. */
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi, ActivityAware {
  public static final String TAG = "NeoVideoPlayerPlugin";
  ...
  @Override
  public void togglePip(@NonNull Messages.TogglePipMessage arg) {
    VideoPlayer player = videoPlayers.get(arg.getTextureId());
    //TODO(matosa): Notify the team about this constraint.
