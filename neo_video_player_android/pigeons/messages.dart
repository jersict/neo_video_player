...
@ConfigurePigeon(PigeonOptions(
  ...
  javaOut: 'android/src/main/java/si/telekom/plugins/neovideoplayer/Messages.java',
...
class TogglePipMessage {
  TogglePipMessage(this.textureId);
  int textureId;
}
...
abstract class AndroidVideoPlayerApi {
  ...
  void togglePip(TogglePipMessage msg);
}
